...
class RelatoriosView extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(currency.format(controller.saldoAtual),
                      style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: controller.saldoAtual >= 0 ? AppTheme.verdeEntrada : AppTheme.carmimSaida)),
                  const Divider(height: 24),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Entradas Totais: ${currency.format(controller.totalEntradas)}', style: const TextStyle(color: AppTheme.verdeEntrada)),
                      Text('Saídas Totais: ${currency.format(controller.totalSaidas)}', style: const TextStyle(color: AppTheme.carmimSaida)),
                    ],
                  ),
                ],
              ),
          ...
          // RF-03 / RF-05: Distribuição Visual de Custos
          Card(
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildCostBar('Custos Fixos (Aluguel, Água, Luz)', controller.totalCustosFixos, controller.totalCustosFixos / totalSaidas, Colors.blue, currency),
                  const SizedBox(height: 12),
                  _buildCostBar('Custos Variáveis (Produtos, Insumos)', controller.totalCustosVariaveis, controller.totalCustosVariaveis / totalSaidas, Colors.amber.shade700, currency),
                  const SizedBox(height: 12),
                  _buildCostBar('Emergências / Imprevistos', controller.totalCustosEmergencia, controller.totalCustosEmergencia / totalSaidas, Colors.red, currency),
                ],
              ),
            ),
          ),
          ...
          // RF-05: Análise de Meios de Pagamento e Taxas de Cartão
          Card(
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text('Estimativa de taxa: ~1.99%'),
                  ...
                  ListTile(
                    ...
                    subtitle: Text('Estimativa de taxa: ~3.99%'),
          ...
          ElevatedButton.icon(
            ...
            label: const Text('EXPORTAR PLANILHA CSV COMPLETA'),
  ...
  Widget _buildCostBar(String label, double valor, double percentual, Color cor, NumberFormat currency) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
